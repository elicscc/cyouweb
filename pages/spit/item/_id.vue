          ...
          <ul class="comment-list" v-infinite-scroll="loadMore">
            <li v-for="(item,index) in commentlist" :key="index">
              <div class="item-photo">
                <img src="https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/widget-widget-photo.png" alt />
              </div>
...
export default {
  ...
  asyncData({params}) {
    return axios
      .all([spitApi.findById(params.id), spitApi.commentlist(params.id,1,12)])
      .then(
    ...
    loadMore() {
      this.pageNo++;
      spitApi.commentlist(pojo.id,this.pageNo, 12).then(res => {
    ...
    spitApi
      ...
      .then(res => {
        ...
        if (res.data.flag) {
          ...
          spitApi.commentlist(this.pojo.id,1,12).then(res => {
