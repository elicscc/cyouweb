...
<div>
  <div class="myhome-personinfo"  :style="backgroundImg" > 
   <div class="wrapper"> 
    <div class="person-baseinfo"> 
     <!--头像信息--> 
     <div class="photo"> 
      <img src="https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/widget-myphoto.jpg" alt="" class="person" /> 
      <div class="share"> 
       <span><img src="https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/asset-QQ.png" alt="" width="34" height="28" /></span> 
       <span><img src="https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/asset-weixin.png" alt="" width="28" height="28" /></span> 
       <span><img src="https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/asset-weibo.png" alt="" width="28" height="28" /></span> 
      </div> 
     </div> 
     <!--文字信息--> 
     <div class="info"> 
    ...
    <!--右侧编辑--> 
    <div class="edit-info"> 
     <h4>个人简介<span class="addedit"><img src="https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/widget-edit.png" width="12" height="12" />编辑</span></h4> 
     <div class="info-box"> 
...
export default {
  data(){
    return{
      backgroundImg:{
          backgroundImage:"url(https://cdn.jsdelivr.net/gh/elicscc/tens-web/assets/img/widget-homebg.png)"
      },
      user:{}
    }
  },
